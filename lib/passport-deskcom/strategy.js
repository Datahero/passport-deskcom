...
function Strategy(options, verify) {
  options = options || {};
  if (!options.site)
    throw new Error('passport-deskcom Strategy requires desk.com site url');
  ...
  this.DESK_CREDENTIAL_URL = options.site + DESK_CREDENTIAL_PATH;
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  this._oauth.get(this.DESK_CREDENTIAL_URL, token, tokenSecret, function (err, body, res) {
    if (err)
